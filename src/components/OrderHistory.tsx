...
const OrderHistory = ({ onClose, onEditOrder }: OrderHistoryProps) => {
    ...
    const loadOrders = async () => {
        ...
        try {
            ...
            const allOrders = await orderApi.getAllOrders(statusFilter, 100);
            setOrders(allOrders);
        } catch (error) {
    ...
    // Find items that were removed or changed
                                        ...
                                        <div className="text-right flex flex-col gap-2">
                                            ...
                                            {(order.status === 'pending' || order.status === 'paid') && onEditOrder && (
                                                <button
                                                    ...
                                                    className="px-4 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium transition-colors"
                                                >
                                                    Edit Order
                                                </button>
                                            )}
