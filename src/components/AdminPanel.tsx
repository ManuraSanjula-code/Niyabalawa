...
type ProductCategory = 'main' | 'rice' | 'addon';
...
const AdminPanel: React.FC<AdminPanelProps> = ({ onClose, onProductAdded }) => {
  ...
  const handleTabChange = (tab: ProductType) => {
    ...
    setFormData({
      ...
      halfPrice: '',
      fullPrice: '',
      category: tab === 'set-menu' ? 'main' : 'addon',
      kitchen: 'front'
    });
    setMessage(null);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({
        ...
        halfPrice: '',
        fullPrice: '',
        category: activeTab === 'set-menu' ? 'main' : 'addon',
        kitchen: 'front'
      });
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                {activeTab === 'set-menu' 
                  ...
                  : 'This item will appear in the DESSERT/DRINKS tab (cakes, ice cream, beverages, etc.)'
                }
              </p>
            </div>
